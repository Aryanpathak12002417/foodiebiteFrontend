...
//   return (
//     <section className='md:h-screen flex flex-col items-center bg-[#f5f8fbbd] relative'>
...
import QuickMealCard from './QuickMealCard'
    ...
    <div className='py-12 my-8'>
        <div className='flex justify-center items-center p-4 lg:p-6'>
            <div className='flex flex-col justify-center items-center'>
                <h6 className='lg:mx-6 font-jernin md:text-md lg:text-lg font-medium'>What's On</h6>
                <h3 className='text-2xl lg:text-6xl font-jernin font-bold text-slate-900'>Today's Menu</h3>
            </div>
        </div>

        <div className='flex justify-center flex-wrap w-full mt-8 px-5'>
            <QuickMealCard imageUrl={veg1} tags={['Spicy','Ethentics']}/>
            <QuickMealCard imageUrl={veg2}/>
